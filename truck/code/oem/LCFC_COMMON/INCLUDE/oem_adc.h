...
#define ADC_Channel_SUPPORT ( ADC_Channel_3  | ADC_Channel_4 | ADC_Channel_5 | ADC_Channel_6 | ADC_Channel_7)
#else
#define ADC_Channel_SUPPORT ( ADC_Channel_3  | ADC_Channel_5 | ADC_Channel_6 | ADC_Channel_7)//(ADC_Channel_1 | ADC_Channel_2 | ADC_Channel_3 | ADC_Channel_4 | ADC_Channel_5 | ADC_Channel_6 | ADC_Channel_7 )
#endif
