...
//[Project][CC20130425][End]Add first used date feature.
   ...
   case 0xBE:
   	    ACPI_PPM_RESET_CMD_Flag = PM1Data;
		if(ACPI_PPM_RESET_CMD_Flag==0x22)
   	   	ACPI_CMD_PPM_RESET();
   //A485D000146--->End		
   #endif
  }
...
//[Project][CC20130425][End]Add first used date feature.
   ...
   #endif
   //A485D000135+ end
   //A485D000146--->Start for UCSI PPM Reset workround
   #if ENABLE_UCSI_HangA8A9_Workaround 
   case 0xBE:
   	 PM1Step=0x01;
        break;
   #endif
  //A485D000146--->End David+ 180613 for UCSI PPM Reset workround
  }
}
