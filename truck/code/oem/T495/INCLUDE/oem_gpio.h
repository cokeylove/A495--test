...
#define PortB5_Ctrl   INPUT            // 126 A485D00064: Change GPB5 to input pin GATEA20
...
#define PortD5_Ctrl   INPUT             // 33 A485D00063: Change GPD5 to input pin //DOCK_USB2_BUS_EN# A485D00032+ BPWRG //PD_VBUS_C_CTRL1_EC
...
//-----------------------------------------------------------------
#define PortE_Init    0x14              // PORT Data//EC
...
#define PortE4_Ctrl   OUTPUT            //A485D00059: Enable EC_ON_5V by SCH Change   // 125  LAN_WAKE#
...
#define PortI4_Ctrl   INPUT//ALT               // 70   _ADC4 for FAN_ID //A485D00039
...
//-----------------------------------------------------------------
#define PortL_Init		0x00            // PORT Data  //A485D000138 0x80->0x00

#define PortL0_Ctrl		INPUT			//A485D00062: Change GPL0 to input pin//USBC_USB2_BUS_EN# //A485D00032+	EC_ON2//TP4RST
...
#define Read_EnBeep_Active()   IS_MASK_CLEAR(GPDRB,BIT(5)) //A485D00087:
...
#define EC_ON_HI()        		SET_MASK(GPDRE,BIT(2))//A485D000101-//{SET_MASK(GPDRE,BIT(2)); SET_MASK(GPDRE, BIT(4));} //A485D00059: Enable EC_ON_5V for SCH change//A485D00032- for EE change
#define EC_ON_LOW()       		CLEAR_MASK(GPDRE,BIT(2))//A485D000101-//{CLEAR_MASK(GPDRE,BIT(2)); CLEAR_MASK(GPDRE, BIT(4));} //A485D00059: Enable EC_ON_5V by SCH Change//A485D00032-for EE change
...
//#define Read_105VS_VDDPPG()  	IS_MASK_SET(GPDRH,BIT(6))//A485D00071-//IS_MASK_SET(GPDRD,BIT(4))
//#define Read_09VS_PG()			IS_MASK_SET(GPDRH,BIT(6))//A485D00071-
...
//#define CHK_095VS_PGD()            IS_MASK_SET(GPDRH,BIT(6))// A485D00071- //David+ for SCH Modify
//-----------------------------------------------------------------------------
// LED control
//-----------------------------------------------------------------------------
#if Support_FnLKLED
...
#define Read_VLAN_PWR()                         IS_MASK_CLEAR(GPDRC,BIT(0))		//A485D000106+
...
#define Read_FANID_HIGH()		IS_MASK_SET(GPDRI,BIT(4))  //A485D00039+
...
#define Read_LAN_WAKE_IN()  	0 //(SystemIsS3 ? IS_MASK_CLEAR(GPDRD,BIT(1)) : 0) //A485D00061:Change Wlan wake from GPDE4 to GPD1
#define Read_SYS_LAN_WAKE_IN()	IS_MASK_CLEAR(GPDRD,BIT(1))
//A485D00059: Enable EC_ON_5V by SCH Change  --->Start
#define EC_ON_5V_High()     SET_MASK(GPDRE,BIT(4))
#define EC_ON_5V_Low()      CLEAR_MASK(GPDRE,BIT(4))
#define Read_EC_ON_5V()     IS_MASK_SET(GPDRE,BIT(4))
//A485D00059: Enable EC_ON_5V by SCH Change  --->End
#if (PLATFORM_CHIP == INTEL)
