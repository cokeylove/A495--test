...
typedef struct _FanTableList {
	//thermal table
  const FanControlstruct *TsTbl;  //A485D00092
  BYTE 		TsTblCount;
...
//A485D00039
#define FAN_VEN_GPIO_0		0
#define FAN_VEN_GPIO_1		1
...
#define THERMAL_STB_ENABLE_TEMP_THRESHOLD		(52)
#define THERMAL_STB_DISABLE_TEMP_THRESHOLD		(48)
