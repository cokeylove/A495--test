...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#define Support_EC_Sleep      TRUE   // Support EC sleep function. //A485D00018: Enable EC deep sleep mode
...
#define ENABLE_64G_KEY_WORK_RUN         (TRUE)  //A485D000135+
#define ENABLE_UCSI_HangA8A9_Workaround  (FALSE)  //A485D000146  David+180613 for UCSI PPM Reset workround
...
#define FAN_CTRL_CPUFAIL_ALERT      (1)

#define PD_ENABLE_COMMFAIL_RESET    (0) // //A485D000147-A485D000114: add PD communication fail reset function
...
#define Support_SMTADP        FALSE   // Support Smart Adaptor  ////A485D00057: Fix wake on lan Fail
...
#define Support_IFC				FALSE //A485D00065: Disable support IFC for thermal change
#define	IFC_TEMP				44
#define STP_THOT_ON				76  //A485D00092
#define STP_THOT_OFF			65
#define	STP_SHDN				99
#define VEN1_STP_FAN_RPM		35	// Toshiba
#define VEN1_STP_FAN_DUTY		60

#define VEN2_STP_FAN_RPM		36	// null
#define VEN2_STP_FAN_DUTY		60

#define VEN3_STP_FAN_RPM		38	// Delta
...
#define Support_MAXPWR        TRUE  //A485D00054:
...
#define Thinkpad_Battery_HW_Auth  TRUE  // Battery authencation by EC HW(CHIP). //A485D00019: Enable Battery HW Authentication
#define Lenovo_Authentication TRUE  //A485D00017: Enable Battery SW authentication.
...
#define Trickle_Control_By_CHGIC FALSE//TRUE //A485D00041   // FALSE:control by EE, TRUE: control by charge IC
...
#define SmBat_Addr       0x36    // smart battery address
