...
#if 0
		SET_MASK(GCR9,PWSWDT2GPEN);  //A485D00036 for EE  test
		GPCRI5= ALT;                 //A485D00036 for EE  test
 #endif 	
...
//---------------------------------------------------------------------------	
	...
	//A485D000106+ fix wol cannot wakeup for g3 mode start
	...
	//A485D000106+ fix wol cannot wakeup for g3 mode end
	#endif
...
void Init_ClearRam(void)
{
  ...
  temp2 = WinFlashMark;
  temp3 = WinFlashMark2;
  temp4 = afterFlashMark; // A485D00044:
  ...
  WinFlashMark = temp2;
  WinFlashMark2 = temp3;
  afterFlashMark = temp4;  //A485D00044:
}
...
void OEM_PWRSWWDTEn()
{
	...
	PWRBTN_WDTFLAG = TRUE;  //David+// A485D00043 Fix auto boot on after 8S reset
}
