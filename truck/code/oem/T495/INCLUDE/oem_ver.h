...
#define REV0_BYTE1    0x02  // 2nd version from 1 to 99
...
#define REV0_BYTE4    0x34// Series number of EC F/W release

#define CHIP_TYPE0    0x0B  // 8186 - Chip type
#define tModuName0    "Tx95" // for module name

//Cmd_52_A0   report LCFC project name
#define OEM_PROJECT1  "T495"			//14"	Windu
#define OEM_PROJECT2  "T495"			//"DA275"    //12"	Wolvrine
...
#define OEM_BuildID3 'W'//( IS14Inch ? '4' : 'N' )//A485D00013:Modify Verson name
