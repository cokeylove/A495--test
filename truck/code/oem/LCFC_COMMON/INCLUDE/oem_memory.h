...
//A485D000120: fix usb3.0 identify abnormal
...
#define   pBattLearn								SD_uchar_8(OEMRAM2+0xAB)
 ...
 #define  PKShiftCMD      					BIT6   //A485D000121
...
#define   GPU_THROTTLE_SRC							SD_uchar_8(OEMRAM3+0x04)  
 ...
 #define  BAT_OCP_Event_En              BIT6  //A485D000127
...
#define  Read_CHIC_MinSystemVoltage1							SD_uchar_8(OEMRAM4+0xF8)
#define  Read_CHIC_MinSystemVoltage2							SD_uchar_8(OEMRAM4+0xF9)
//A485D000124: Fix battery can not charge full in S0
#define  MinSysVolConfirmByte       						SD_uchar_8(OEMRAM4+0xFA)//	//A485D000144
#if ENABLE_UCSI_HangA8A9_Workaround
#define  ACPI_PPM_RESET_CMD_Flag                    SD_uchar_8(OEMRAM4+0xFC)  //A485D000146-+
#endif
#define  Debug_Test_3FB							SD_uchar_8(OEMRAM4+0xFB)  
//#define  Debug_Test_3FC							SD_uchar_8(OEMRAM4+0xFC)  ////A485D000146-
...
//A485D000114: add PD communication fail reset function
#define  TYPE_C_RAM48           SD_uchar_8(OEMRAM9+0xAA)
#define  TYPE_C_RAM49           SD_uchar_8(OEMRAM9+0xAB)

#if ENABLE_64G_KEY_WORK_RUN //A485D000135
#define USB_Delay                   SD_uchar_8(OEMRAM9+0xB0)
#endif
#define TypeC_LenovoAdaptor         SD_uchar_8(OEMRAM9+0xB2) ////A485D000151+
    #define Port1_IslenovoAdaptor			BIT0
	#define Port2_IslenovoAdaptor			BIT1
#define TypeC_LenovoAdaptor_P1HWResetTimes         SD_uchar_8(OEMRAM9+0xB3)  ////A485D000151+
#define TypeC_LenovoAdaptor_P2HWResetTimes         SD_uchar_8(OEMRAM9+0xB4)  ////A485D000151+
#define  PD4ccCMD_WaitCnt                          SD_uchar_8(OEMRAM9+0xBA) //A485D000154:+
//-------------------------------------------------------------------------
...
#define   u4KBDID									SD_uchar_8(OEMRAMA+0x09)
 ...
 //A485D000141--->S
#define   KB_Buffer_Status					SD_uchar_8(OEMRAMA+0x0A)
#define   Chk_Buf_Half_Full_En          		BIT0
//A485D000141--->E
...
#define   u4SenseSTS3								SD_uchar_8(OEMRAMA+0x49)
 ...
 ////A485D000122://A485D000116: Add unsupport adapter process,set flag for bios
...
#define  uShipModeWorkRun                                           SD_uchar_8(OEMRAMA+0xD4)//A485D000150+
