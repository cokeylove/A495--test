...
//
  ...
  { S5S0_SUSP_HI,         10,       0,  },  // 8
  { S5S0_USBON,            21,       0,  },  // 9  
  //{ S5S0_CHK_095VSVDDPPG, 20,       1,  },  //A485D00060: Del CHK_095VS_PGD in power sequence for SCH change 10 A //david + 10->20
...
{
  //for project design
  //PWR_GOOD_D_LOW();  ////A485D00071-   for 4S shutdown auto boot on
...
//
  ...
  { Sequence_Null,         0,       0,  },  // Dummy step always in the top of tabel
  { S0S5_CHK_S5S3,         1,       0,  },  // 1
  //{ S0S5_SUSP_OFF,         0,       0,  },  // 2//A485D00071-  
  { S0S5_PWRGOOD_LOW,      2,       0,  },    //A485D00071+  
  //{ S0S5_CHK_095VSVDDPPG,  0,       1,  },  // 3//A485D00071-  
  { S0S5_APUPWR_EN_OFF,   30,       0,  },  // 4
  //{ S0S5_SYSON_OFF,       20,       0,  },  // 5//A485D00071-
...
//
  ...
  //{ S0S3_SUSP_OFF,         0,       0,  },  // 2//A485D00071-
  { S0S3_PWRGOOD_LOW,         2,       0,  }, //A485D00071+
  // { S0S3_SUSP_OFF,         0,       0,  },  // 2 //A485D00071-
 // { S0S3_CHK_095VSVDDPPG,  0,       1,  },  // 3 //A485D00071-
...
//
    ...
    { S3S0_CHK_S3,          1,       1,  },  // 4
    { S3S0_SUSP_HI,        10,       0,  },  // 5 //A485D00060: Del CHK_095VS_PGD in power sequence for SCH change
...
void Oem_SysPowerContrl(void)
{
  ...
  switch (SysPowState)
  {
    ...
    case SYSTEM_S5:
     ...
     //A485D00066: Pull high RSMRST when AC-In for Type-C Display issue --->Start 	
	if(Read_VDDPALWPWRGD() && Read_AC_IN())
	 {
		...
		{RSMRSTDelayCnt=0; }
   //A485D00071+//A485D00066: Pull high RSMRST when AC-In for Type-C Display issue --->End
      if(Read_SLPS3() && Read_SLPS5())
      {
        DelayDoPowerSeq = 0;
        PWSeqStep = 1;
...
{
	//remove WOLACWakeEnGet for +3VALW cannot low - 20180418
    ...
    || (IS_MASK_CLEAR(SYS_STATUS,AC_ADP) && (USBALWONGet)))//A485D000128//A485D00098
	{EC_ON_5V_Low();} //A485D00098
	//EC_ON2_LOW();
	AC_PRESENT_LOW();
	EC_WAKE_OUT_LOW();
